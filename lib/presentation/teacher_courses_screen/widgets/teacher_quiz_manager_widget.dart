...
class _CourseQuizManagerWidgetState extends State<CourseQuizManagerWidget> {
  ...
  void _addQuestion(CourseQuiz quiz) {
    _showQuestionDialog(quiz, null);
  }

  void _editQuestion(CourseQuiz quiz, CourseQuestion question) {
    _showQuestionDialog(quiz, question);
  }

  void _deleteQuestion(CourseQuiz quiz, CourseQuestion question) {
    showDialog(
      context: context,
      builder: (ctx) => _ConfirmDeleteDialog(
  ...
  void _showQuizDialog(CourseQuiz? existing) {
  ...
  void _showQuestionDialog(CourseQuiz quiz, CourseQuestion? existing) {
