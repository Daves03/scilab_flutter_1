...
class _UnityArScreenState extends State<UnityArScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: _isExperimentActive ? null : AppBar(title: const Text('Select an Experiment')),
        body: Stack(
          children: [
            Offstage(
            ...
            // --- GRID SELECTION MENU (When experiment is inactive) ---
            if (!_isExperimentActive && !_isLoading)
              Container(
                color: theme.colorScheme.surface,
                child: SafeArea(
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Available Labs', style: theme.textTheme.headlineSmall),
                        const SizedBox(height: 8),
                        Text('Select an experiment to launch the AR camera.',
                        ...
                        Expanded(
                          child: GridView.count(
                            ...
                            children: [
                              _ExperimentCard(
                                title: 'Reaction 1',
                                subtitle: 'Elephant Toothpaste (Yeast last).',
                                onTap: () => _launchExperiment('1'),
                              ),
                              _ExperimentCard(
                                title: 'Reaction 2',
                                subtitle: 'Analyze the resulting compounds.',
                                onTap: () => _launchExperiment('2'),
                              ),
                            ],
                          ),
                        ),
...
class _ExperimentCard extends StatelessWidget {
  ...
  const _ExperimentCard({required this.title, required this.subtitle, required this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(16),
          // Notice I used .withValues() here too!
