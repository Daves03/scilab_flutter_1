...
class _StudentProfileScreenState extends State<StudentProfileScreen> {
  ...
  Future<void> _loadStudentData() async {
    ...
    setState(() {
      ...
      _gradeLevel = prefs.getString('student_grade') ?? 'Grade 9';
      _schoolSection = prefs.getString('student_section') ?? '';
    });
  }
                    ...
                    Container(
                      ...
                      child: ClipOval(
                        child: Image.network(
                          ...
                          fit: BoxFit.cover,
                          semanticLabel:
                              'Student profile avatar showing a young person with a friendly smile',
